...
import { OfficialDocumentType } from "@/redux/slices/officialDocumentsSlice";
import Link from "next/link";
import { FaEdit, FaPaperclip } from "react-icons/fa";

type OfficialDocumentsTableProps = {
...
export const getColumns = ({
  handleEdit,
  handleDelete,
}: OfficialDocumentsTableProps): ColumnDef<
  OfficialDocumentType & { index: number }
>[] => [
  {
    accessorKey: "name",
