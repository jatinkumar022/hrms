...
import { fetchEarlyOutRecords } from "@/redux/slices/attendance/earlyOutSlice";
...
export default function MyEarlyOutPage() {
  const dispatch = useAppDispatch();
  const {
    records,
    loading: isLoading,
    error: errorMessage,
  } = useAppSelector((state) => state.earlyOut);
